...
/// 2026: 15 universities · 2027: 42 · 48 distinct.
const Map<String, List<int>> approvedYears = {
  ...
  'a38e0ca9-856b-4a8b-9a86-4ee1b00a38e4': [2026, 2027], // Korea National Sport
  'a79aab64-8ad7-4b96-8d60-dd7664822446': [2026, 2027], // Kyungdong
  // 2026 only
  '16038490-c33c-4177-9d82-e29edfeffb01': [2026], // Seoul Nat Univ of S&T
  'c18af385-9d41-43f8-b7bb-312240ade9c9': [2026], // Dongnam Health
  'a11cdb3a-efae-4bde-942a-b948bad911db': [2026], // Ewha Womans
  'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb': [2026], // Hanyang University
  '504d551b-5249-4312-ba65-6f8323e5c54f': [2026], // Kyung Hee
  'dedc9b3c-6c4c-4e76-a5e1-6e93f23d406f': [2026], // Myongji University
  // 2027 only
  ...
  '0482a093-cece-49b7-aab9-306085b4ecf5': [2027], // Cheongju
...
const Map<String, ApprovedUniDetail> approvedUniDetails = {
  ...
  '0482a093-cece-49b7-aab9-306085b4ecf5': ApprovedUniDetail(topikMin: 3, interviewRequired: true, englishAccepted: true), // Cheongju
  ...
  'c18af385-9d41-43f8-b7bb-312240ade9c9': ApprovedUniDetail(topikMin: 3, interviewRequired: false, englishAccepted: false), // Dongnam Health
  ...
  'a11cdb3a-efae-4bde-942a-b948bad911db': ApprovedUniDetail(appStart: '2026-03-04', appEnd: '2026-04-03', docDeadline: '2026-05-15', topikMin: 4, interviewRequired: false, englishAccepted: false), // Ewha Womans
  ...
  'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb': ApprovedUniDetail(appStart: '2025-07-09', appEnd: '2025-07-11', docDeadline: '2025-07-31'), // Hanyang University
  ...
  'a38e0ca9-856b-4a8b-9a86-4ee1b00a38e4': ApprovedUniDetail(appStart: '2025-12-29', appEnd: '2025-12-31', docDeadline: '2025-12-31', topikMin: 3, interviewRequired: true, englishAccepted: false), // Korea National Sport
  ...
  '504d551b-5249-4312-ba65-6f8323e5c54f': ApprovedUniDetail(appStart: '2025-12-08', appEnd: '2025-12-12', docDeadline: '2025-12-12'), // Kyung Hee
  'a79aab64-8ad7-4b96-8d60-dd7664822446': ApprovedUniDetail(appStart: '2026-03-01', appEnd: '2026-08-31', docDeadline: '2026-08-31', topikMin: 3, interviewRequired: true, englishAccepted: true), // Kyungdong
  ...
  'dedc9b3c-6c4c-4e76-a5e1-6e93f23d406f': ApprovedUniDetail(appStart: '2025-07-07', appEnd: '2025-07-11', docDeadline: '2025-07-11', interviewRequired: true, englishAccepted: false), // Myongji University
